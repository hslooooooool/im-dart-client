...
class MessageModel extends $pb.GeneratedMessage {
  ...
  MessageModel._() : super();
  factory MessageModel() => create();
  factory MessageModel.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MessageModel.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  MessageModel clone() => MessageModel()..mergeFromMessage(this);
  MessageModel copyWith(void Function(MessageModel) updates) => super.copyWith((message) => updates(message as MessageModel));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static MessageModel create() => MessageModel._();
  MessageModel createEmptyInstance() => create();
  static $pb.PbList<MessageModel> createRepeated() => $pb.PbList<MessageModel>();
  @$core.pragma('dart2js:noInline')
  static MessageModel getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MessageModel>(create);
  static MessageModel _defaultInstance;
